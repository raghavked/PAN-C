...
const BASE_URL = import.meta.env.VITE_MONGODB_DATA_API_URL;
const API_KEY  = import.meta.env.VITE_MONGODB_API_KEY;
const DATABASE = import.meta.env.VITE_MONGODB_DATABASE || 'pan_c';
const DATA_SRC = import.meta.env.VITE_MONGODB_DATA_SOURCE || 'Cluster0';
